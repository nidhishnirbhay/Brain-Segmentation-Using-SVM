...
% Last Modified by GUIDE v2.5 18-Apr-2019 14:59:52
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[FileName,PathName] = uigetfile('*.jpg;*.png;*.bmp','Pick an  Image of Organ');
...
set(handles.edit20,'string',Max_Accuracy);
 if strcmpi(species,'MALIGNANT')
     helpdlg(' Detected ');
     disp('Tumor Detected');
 else
     helpdlg(' Tumor not Detected ');
     disp('Tumor not Detected');
 end
